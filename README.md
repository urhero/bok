...
- **Input**: 팩터별 종목 데이터 리스트 + 약어 리스트 (길이 일치 검증 포함)
...
| `transaction_cost_bps` | 30.0 | 거래비용 (basis points) | `weight_construction.py` |
...
| `backtest_start` | "2017-12-31" | 백테스트 시작일 | `weight_construction.py` |
