...
| `turnover_smoothing_alpha` | 0.1 | mp/backtest EMA 블렌딩 비율 (1.0=off) | `smoothing.py`, `model_portfolio.py`, `walk_forward_engine.py` |
| `turnover_min_weight` | 0.01 | EMA 메모리 prune 임계값 (비중<값 AND 미선정 제거 후 renorm) | `smoothing.py` |
