...
2-b. **TS 모멘텀 틸트** (`ts_mom_window=4`, 캡 재분배 **이전** base 단계 적용): trailing 4개월 자기 누적수익이 음수인 팩터의 비중을 `ts_mom_scale=0.5`배 감쇠. 2026-08-06 순서 교정 — 구 구현(캡 후 틸트)은 스타일 합이 캡을 초과했음 (2026-06-30 EQ 26.1%). 교정 후 캡 25% 준수, factor-level Sharpe 영향 +0.001로 미미
