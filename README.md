...
| `turnover_step` | 0.01 | 절대스텝 스무딩: 월 최대 factor 이동폭 (1%p) | `smoothing.py`, `model_portfolio.py`, `walk_forward_engine.py` |
| `turnover_deadband` | 0.003 | no-trade 밴드 (factor 변동<값이면 고정, 거래 0) | `smoothing.py` |
